...
export default function LearnNewSkill() {
  ...
  //Frases que aparecem no menu inicial de acesso ao site
  return (
          ...
          <div className="col-xl-5 col-lg-6 col-md-10 order-2 order-lg-1">
            <div className="about-content">
              <h2
                ...
                data-aos="fade-up"
              >
                <span>Gerencie</span> sua instituição quando e onde quiser.
              </h2>
              <p className="about-content__text" data-aos="fade-up">
                <strong>Por que escolher nossa plataforma?</strong>
                <br />
              </p>
              ...
              <div className="d-inline-block mt-30">
                <Link to="/login" className="button -md -dark-1 text-white">
                  Acessar plataforma
                </Link>
              </div>
            </div>
