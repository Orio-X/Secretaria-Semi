            ...
            <div className="col-12">
              ...
              >
                ...
                <div className="w-1/1 ml-30 lg:ml-0 lg:mt-20">
                  ...
                  <p className="mt-10">
                  Carregue a imagem do seu curso aqui. Ela deve atender aos nossos padrões de qualidade para ser aceita. 
                  Diretrizes importantes: 750x440 pixels; .jpg, .jpeg, .gif ou .png. 
                  Sem texto na imagem.
                  </p>
                </div>
              </form>
