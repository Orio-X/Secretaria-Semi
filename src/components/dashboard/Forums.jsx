          ...
          <div className="col-12">
            <div className="rounded-16 bg-white shadow-4 h-100">
              ...
              <div className="py-30 px-30">
                ...
                <div className="mt-15">
                  Neste espaço, discutiremos aspectos dos filmes e da psicologia no cinema em geral. Sinta-se à vontade para levantar questões que possam ajudá-lo com tarefas futuras e projetos em grupo. Esta é uma área de mente coletiva! Você pode avaliar outros e visualizar avaliações.
                </div>
            ...
            <div className="rounded-16 bg-white shadow-4 h-100">
              <div className="d-flex justify-between items-center py-20 px-30 border-bottom-light">
                <h2 className="text-17 lh-1 fw-500">
                  Discussão do Curso: A Atração pela Doença Mental
                </h2>
                  ...
                  >
                    ...
                    >
                      <span className="js-dropdown-title">
                        Exibir Respostas em Forma de Tópico
                      </span>
                      <i className="icon text-9 ml-40 icon-chevron-down"></i>
                    </div>
