...
class Aluno(models.Model):
    ...
    #  choices em campos como turmaa e disciplina criar uma padronização.
    ...
    # ForeignKey para relacionar alunos com responsáveis e notas

    Responsavel = models.ForeignKey(Responsavel, on_delete=models.CASCADE, null=False)
    aluno_nota = models.ForeignKey(Nota, on_delete=models.CASCADE, null=True, blank=True, related_name="aluno_nota")
...
class AtividadePendente(models.Model):
    ...
    #  Campos para alinhar com a UX desejada:
